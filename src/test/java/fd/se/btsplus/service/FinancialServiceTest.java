...
class FinancialServiceTest {
    ...
    void predict() {
        ...
        assertEquals(120d * 0.98,financialService.predict(stock,stockDaily));
        ...
        assertEquals(120d * 1.06,financialService.predict(stock,stockDaily));
    ...
    void queryProducts() {
        ...
        assertTrue(financialService.queryProducts("no_product").size()==0);
    }
    ...
    void purchaseFund() {
        ...
        assertEquals(HTTP_NOT_FOUND, financialService
                .purchaseFund(222L, account, 10, period).getCode());
        assertEquals(HTTP_NOT_ACCEPTABLE,financialService
                .purchaseFund(11L,account,20000,period).getCode());
        assertEquals(HTTP_OK,financialService
                .purchaseFund(11L,account,1,period).getCode());
    }
