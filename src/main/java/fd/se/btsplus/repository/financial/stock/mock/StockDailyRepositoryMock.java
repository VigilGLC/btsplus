...
public class StockDailyRepositoryMock implements StockDailyRepository, IRepositoryMock {
    private static final String PATH = "json/financial/stock/stockDaily's.json";
    @NonNull
    private final ResourceUtils resourceUtils;
    @NonNull
    private final JsonUtils jsonUtils;
    private Set<StockDaily> set;
    ...
    public void init(String path) {
        ...
        this.set = new HashSet<>(jsonUtils.readList(jsonStr, StockDaily.class));
    }
